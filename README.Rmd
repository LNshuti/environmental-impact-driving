...
rwa_sum <-
  ...
  mutate(product_name = ifelse(grepl("special", product_name), "special transacts",product_name)) %>%
  mutate(product_name = ifelse(grepl("clothing ", product_name), "clothing",product_name)) %>%
  mutate(product_name = ifelse(paste(c("communication", "radio", "telecom"), collapse="|"), 
                               "telecom", product_name)) %>%
  mutate(product_name = ifelse(paste(c("petroleum", "petrol.", "crude oil"), collapse="|"), 
                               "petroleum", product_name)) %>%
  
  mutate(product_name = ifelse(paste(c("beans", "legumes", "vegetables","cane sugar",
                                       "wheat", "corn", "maize", "sugar", "soy", "sugar",
                                       "meal", "cereal", "hydrogenated oils", "animal",
                                       "beet"
                                       ), collapse="|"), 
                               "food products", product_name)) %>%
