...
rwa_sum <-
  ...
  mutate(product_name = ifelse(grepl("petroleum", product_name),
                               "petroleum",product_name)) %>%
  mutate(product_name = ifelse(grepl("petrol.", product_name),
                               "petroleum",product_name)) %>%
  mutate(product_name = ifelse(grepl("telecom", product_name),
                               "telecom",product_name)) %>%
  mutate(product_name = ifelse(grepl("beans", product_name),
                               "food",product_name)) %>%
  mutate(product_name = ifelse(grepl("legumes", product_name),
                               "food",product_name)) %>%
  mutate(product_name = ifelse(grepl("vegetables", product_name),
                               "food",product_name)) %>%
  mutate(product_name = ifelse(grepl("cane sugar", product_name),
                               "food",product_name)) %>%
  mutate(product_name = ifelse(grepl("meal", product_name),
                               "food",product_name)) %>%
  mutate(product_name = ifelse(grepl("cereal", product_name),
                               "food",product_name)) %>%
  mutate(product_name = ifelse(grepl("refined sugar", product_name),
                               "food",product_name)) %>%
  mutate(product_name = ifelse(grepl("hydrogenated oils", product_name),
                               "food",product_name)) %>%
  mutate(product_name = ifelse(grepl("animal or vegetable", product_name),
                               "food",product_name)) %>%
  mutate(product_name = ifelse(grepl("anim./veget", product_name),
                               "food",product_name)) %>%
  mutate(product_name = ifelse(grepl("animal/veg", product_name),
                               "food",product_name)) %>%
  mutate(product_name = ifelse(grepl("cane/beet", product_name),
                               "food",product_name)) %>%
  mutate(product_name = ifelse(grepl("refined sugar", product_name),
                               "food",product_name)) %>%
  mutate(product_name = ifelse(grepl("motor vehicles", product_name),
                               "motor vehicles",product_name)) %>%
  mutate(product_name = ifelse(grepl("passenger", product_name),
                               "motor vehicles",product_name)) %>%
  mutate(product_name = ifelse(grepl("batteries", product_name),
                               "batteries",product_name)) %>%
  mutate(product_name = ifelse(grepl("furniture", product_name),
                               "furniture",product_name)) %>%
  mutate(product_name = ifelse(grepl("leather", product_name),
                               "leather",product_name)) %>%
  
    mutate(product_name = ifelse(grepl("fertilizers", product_name),
                               "fertilizers",product_name)) %>%
  mutate(product_name = ifelse(grepl("constr/mining", product_name),
                               "construction",product_name)) %>%
   mutate(product_name = ifelse(grepl("pulley", product_name),
                               "construction",product_name)) %>%
...
rwa_sum %>%
  filter(year > 2005) %>%
  select(product_name) %>% 
  filter(grepl("parts", product_name)) %>%
  unique() %>%
  View()
